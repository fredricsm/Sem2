...
public class SimEvent {
	 ...
	 * Create a new event
	 * 
	 * This event object is used to pass information from whoever triggered the
	 * event, to the handlers that will handle it.
	 * 
	 * 
	 * @param source
	 ...
	 * @param related
	 *            A sim-object related to the event, if any (can be null)
	 * @param data
	 *            Any other data object that should be passed to the handler
	 *            (can be null)
	 */
